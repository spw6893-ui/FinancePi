...
- If MCP or institutional connectors are available in the session, use them for estimates, transcripts, ownership, institutional financials, private-market data, and audited data packs before relying on general web search.
