...
- For short-term move attribution, event risk, pinning, squeeze/unwind, or "where are the walls" questions, use options positioning when available: put-call ratio, call wall, put wall, max pain, and estimated gamma exposure. Treat gamma exposure as public options-chain-derived positioning, not a dealer book; mention delayed open interest, unknown customer/dealer direction, and source freshness.
...
- The project skill /skill:institutional-holdings exposes an institutional ownership workflow for 13F, 13D/13G, NPORT, fund-holder, activist, top-holder, and institutional ownership questions. Use it when the user asks who owns a stock, which funds bought or sold, whether institutional flow supports a thesis, or how to interpret reported put/call positions. Treat these filings as delayed snapshots and separate active managers from passive ETF/index holders.
